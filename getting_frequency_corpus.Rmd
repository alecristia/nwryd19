...
Also, this reveals my rewrites were incomplete, so I added some lines for the onsets that were missing in my initial correspondence list.

The correspondences here looks similar to the one in wrangling but it has more entries because we want to separate each phoneme, and we want to distinguish between short and long

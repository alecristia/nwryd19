...
# a2m fixed, but I think it is better to fix all of these error upstream, in the demo.xlsx file
trnsc$Sex[trnsc$Sex=="F" & !is.na(trnsc$Sex)]<-"G"
...
aggregate(trnsc$phon_score*100,by=list(trnsc$id,trnsc$Sex,trnsc$age.rounded,trnsc$birthOrder,trnsc$matEd),mean)->phon_score
...
aggregate(trnsc$phon_score*100,by=list(trnsc$id,trnsc$age.rounded,trnsc$type),mean)->phon_score

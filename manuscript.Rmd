...
- add table r/d by stim length & age
...
- look through
- consent, "correct", "accuracy"
- help with table 1 (phonological representation but also formatting)
...
We then inspected whether accuracy varied as a function of word length. Results are shown on table XX. This table shows that monosyllables accuracy was much lower than other lengths. This is likely due to the fact that the majority of monosyllables included were chosen because they had sounds that are rare in the world's languages, which may indicate that they are hard to produce or to perceive. 
...
complexCs=c("dp","tp","kp","km","kn","mb","gh")

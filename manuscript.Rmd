...
Aside from @cristia2020infant's hypotheses just mentioned, we have found little discussion of linguistic effects (i.e., potential differences in NWR as a function of language typology) or cultural effects (i.e., potential differences in NWR as a function of other differences across human populations). 
...
colnames(sub_bank_full)<-c("target","realization","age","target_ortho","phono","tokid")
...
colnames(del_bank_full)<-c("target","age","target_ortho","phono","tokid")
...
colnames(match_bank_full)<-c("target","age","target_ortho","phono","tokid")

...
#but rather the sum of sub, del, mat
#a check: colnames(sub_tab) == names(del_tab)
#a check: names(match_tab) == names(del_tab)
...
#sub_tab_prop=t(t(matrix(sub_tab,ncol=length(denom_vec)))/matrix(denom_vec) )
```

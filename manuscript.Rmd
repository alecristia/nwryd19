...
# M2A: Seems like you already did this, and the line below
# is setting the is.na(trnsc$Sex) cases to "G" -- I assume
# that's not a desirable outcome so am commenting it out

...
<!-- M2A: my ear strongly prefers it without the "at", but it could go both ways. -->
...
# M2A: removed the vector since it wasn't needed; no more complaint!
...
<!-- a2m should we point out that the coefficient for cross-ling frequency is reduced, so indirectly corpus frequency does explain a little bit of variance? Or making things too complicated, and just say "so corpus frequency does not explain away these results" -->
<!-- M2A: let's not go into it. because of the way glmer treats collinearity (https://psycnet.apa.org/record/2014-08495-005), it gets complicated quickly in even giving an accurate report of what's going on -->

### Qualitative analyses of NWR mispronunciations

<!-- a2m I realized this section did not belong together with the xling freq section above - are you ok with this title? -->
<!-- M2A: The title is a little long and maybe less informative than it could be. How about something like, "Patterns in NWR mispronunciations"-->
...
<!-- a2m I added info above - is it weird to talk about this here? -->
<!-- M2A: I don't think it's a weird place to add the idea, though I might shorten it a bit when I go through on a writing pass :) -->

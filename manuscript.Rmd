...
- add table with stimuli
- ask Middy about consent, correct, accuracy
...
aggregate(trnsc$correct*100,by=list(trnsc$id,trnsc$age.exact),mean)->overall
aggregate(trnsc$pc*100,by=list(trnsc$id,trnsc$age.exact),mean)->pc
aggregate(trnsc$nld*100,by=list(trnsc$id,trnsc$age.exact),mean)->nld
overall=cbind(overall,pc$x,nld$x)
colnames(overall)<-c("ID","Age","Word","Phoneme","NLD")

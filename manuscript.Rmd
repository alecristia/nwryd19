...
1. add legend to new figure, improve color coding
1. conclusion: definitely the case that Tsi lower than others, but unclear what this is due to; some variation across samples, but since stimuli haven't been carefully matched, and ages either, we can't be totally sure there either -- also, literacy may be another issue
1. revise discussion
1. improve figure 1?

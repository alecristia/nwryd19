...
[^1]: Most people complete their education upon reaching the highest level of a schooling type (e.g., elementary, primary, secondary etc.). This means that most people have 3, 6, 8, 10, or 12 years of education, with few stopping in-between (e.g., 7 years or 9 years). That said, precise years of education are hard to count given an irregularity in ability to pay school fees, school opening times, familial obligations, and more. We asked parents to report their highest completed level of education and inferred the approximate number of years that entails under ideal conditions.
...
apa_table(birthorder.tab,caption="NWR scores measured in whole word accuracy, phoneme-based accuracy, and normalized Levenshtein Distance, separately for the four stimuli lengths.")
```

...
\textbf{({\textbf{???}}) can you please add the IPA in // for all of the items in the excel then save as tsv?}
...
\begin{verbatim}
##        Type Orthographic Phonological Type Orthographic Phonological Type
## 28 practice     nopimade           NA    1         dp:a           NA    2
## 32 practice        poni            NA    1          dpa           NA    2
## 43 practice          wî            NA    1          dpâ           NA    2
## 1      <NA>         <NA>           NA    1          dpê           NA    2
## 2      <NA>         <NA>           NA    1         dpéé           NA    2
## 3      <NA>         <NA>           NA    1          dpi           NA    2
## 4      <NA>         <NA>           NA    1          dpu           NA    2
## 5      <NA>         <NA>           NA    1        gh:ââ           NA    2
## 6      <NA>         <NA>           NA    1         ghuu           NA <NA>
## 7      <NA>         <NA>           NA    1        kp:ââ           NA <NA>
## 8      <NA>         <NA>           NA    1          kpu           NA <NA>
## 9      <NA>         <NA>           NA    1         lv:ê           NA <NA>
## 10     <NA>         <NA>           NA    1          lva           NA <NA>
## 11     <NA>         <NA>           NA    1          lvi           NA <NA>
## 12     <NA>         <NA>           NA    1         t:êê           NA <NA>
## 13     <NA>         <NA>           NA    1         tp:a           NA <NA>
## 14     <NA>         <NA>           NA    1          tpâ           NA <NA>
## 15     <NA>         <NA>           NA    1          tpê           NA <NA>
##    Orthographic Phonological Type Orthographic Phonological Type Orthographic
## 28         kamo           NA    3       dimope           NA    4     diponate
## 32         kani           NA    3       diyeto           NA    4     nomiwake
## 43         kipo           NA    3       meyadi           NA    4     todiwuma
## 1          noki           NA    3       mituye           NA    4     wadikeno
## 2          nomi           NA    3       nademo           NA <NA>         <NA>
## 3          piwa           NA    3       nayeki           NA <NA>         <NA>
## 4          towi           NA    3       nuyedi           NA <NA>         <NA>
## 5          tupa           NA    3       pedumi           NA <NA>         <NA>
## 6          <NA>           NA    3       tiwune           NA <NA>         <NA>
## 7          <NA>           NA    3       tumowe           NA <NA>         <NA>
## 8          <NA>           NA    3       widone           NA <NA>         <NA>
## 9          <NA>           NA    3       wumipo           NA <NA>         <NA>
...
\begin{tabular}{ll}
\toprule
Orthographic & \multicolumn{1}{c}{Phonological}\\
\midrule
dp:a & NA\\
dpa & NA\\
dpâ & NA\\
...
As for substitutions, it was as common for a nasal vowel to be produced as an oral vowel as vice versa (54 oral target vowels produced as nasal vowels, 58 nasal target vowels produced as oral vowels). Substitutions in which the oral nature was preserved but the quality of the vowel was changed were a great deal more common than changes in quality among nasal vowels (202 oral vowels produced with a different quality; 23 nasal vowels produced with a different quality). As for consonants, asymmetries were very marked with more complex consonants (specifically dptpkpkmknmbgh) mispronounced as simple ones (specifically mnlwyvdgptkfhch, 251) than vice versa (2). Simple consonants were mispronounced as other simple consonants quite frequently (135 simple consonants mispronounced as other simple ones, compared to 58 complex ones).

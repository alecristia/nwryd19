...
\caption{\label{tab:tab2-stims}NWR stimuli in orthographic (Orth.) and phonological (Phon.) representations.}
\centering
...
Is it the case that cross-linguistically less common phones are more frequently substituted by more common ones than vice versa? We found that errors involving nasal vowel targets tended to result in a change in nasality (58 nasal targets produced as oral, \textasciitilde{}72\% of substitutions involving nasal vowels) more frequently than in a change in quality (23 nasal targets produced as a different nasal vowel, \textasciitilde{}28\% of substitutions involving nasal vowels). We found that errors involving nasal vowel targets tended to result in a change in nasality (52 oral targets produced as nasal, \textasciitilde{}20\% of substitutions involving nasal vowels) more frequently than in a change in quality (205 nasal targets produced as a different nasal vowel, \textasciitilde{}80\% of substitutions involving nasal vowels).

the proportion of errors for to be mistakenly produced as oral vowels than vice versa once prevalence in our stimuli was taken : 52 oral target vowels produced as nasal (\textasciitilde{}20\% of substituted oral target vowels) and Both oral and nasal vowels were also occasionally substituted by vowels of a different quality that preserved the target oral/nature airflow: 205 oral vowels (\textasciitilde{}2.16\% of targets and 23 nasal vowels (\textasciitilde{}2.36\% of targets).

Among consonants, complex consonants were occasionally substituted by simpler ones (specifically {[}ṭp{]}, {[}tp{]}, {[}kp{]}, {[}km{]}, {[}kṇ{]}, {[}mp{]}, {[}ɣ{]}, and {[}lβʲ{]} as {[}m{]}, {[}n{]}, {[}l{]}, {[}w{]}, {[}j{]}, {[}w{]}, {[}ṭ{]}, {[}g{]}, {[}p{]}, {[}t{]}, {[}k{]}, {[}f{]}, {[}h{]}, and {[}tʃ{]}), 250 times, in approximately 2.43\% of all complex consonant targets. Interestingly, simple consonants were sometimes also substituted by complex ones; this happened 2 times, in approximately 2.43\% of all simple consonant targets. Finally, simple consonants were mispronounced as other simple consonants (120 instances, \textasciitilde{}0.52\% of all simple consonant targets) and complex consonants as other complex consonants (55 instances, \textasciitilde{}0.98\% of all complex consonant targets). Note that the substitutions included phones that are not native to Yélî Dnye but do occur in English (e.g., {[}tʃ{]}); as these data come from careful transcriptions by a native Yélî Dnye speaker who is very fluent in English, we take these segmental substitutions faithfully as an indication that several of our participants have mastered production of some English phones, possibly produced within whole English word forms.
...
\caption{\label{tab:tablength}NWR measured in whole-word scores, and normalized Levenshtein Distance, separately for the four stimuli lengths.}

\begin{tabular}{ll}
\toprule
Word & \multicolumn{1}{c}{NLD}\\
\midrule
47 (22) & 41 (17)\\
79 (22) & 8 (9)\\
78 (19) & 7 (7)\\

...
\item
  maybe add to the last ana the prevalence (ie out of all the gh which proportion get transformed) DONE I think\ldots{} (this item looks the same as one of the three above)
\item
  maybe add analyses of score as a function of frequency (phones, diphones) in MC's corpus? (mc suggested, but I don't think we need it\ldots{}) - waiting until we talk about this
\end{itemize}
